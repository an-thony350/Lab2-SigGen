...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sigdelay__DOT__count = vlSelf->sigdelay__DOT__count;
    vlSelf->__Vdly__sigdelay__DOT__count = ((IData)(vlSelf->rst)
                                             ? 0U : 
                                            (0xffU 
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__ram2ports__DOT__ram_array
    ...
    if (__Vdlyvset__sigdelay__DOT__ram2ports__DOT__ram_array__v0) {
        vlSelf->sigdelay__DOT__ram2ports__DOT__ram_array[__Vdlyvdim0__sigdelay__DOT__ram2ports__DOT__ram_array__v0] 
            = __Vdlyvval__sigdelay__DOT__ram2ports__DOT__ram_array__v0;
    }
}
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->sigdelay__DOT__count = vlSelf->__Vdly__sigdelay__DOT__count;
}
