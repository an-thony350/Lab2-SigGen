...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelf->mic_signal),8);
    bufp->fullBit(oldp+4,(vlSelf->wr));
    bufp->fullBit(oldp+5,(vlSelf->rd));
    bufp->fullCData(oldp+6,(vlSelf->offset),8);
    bufp->fullCData(oldp+7,(vlSelf->incr),8);
    bufp->fullCData(oldp+8,(vlSelf->delayed_signal),8);
    bufp->fullCData(oldp+9,(vlSelf->sigdelay__DOT__count),8);
    bufp->fullCData(oldp+10,((0xffU & ((IData)(vlSelf->sigdelay__DOT__count) 
