...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__1(Vsinegen___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.dout1 = vlSelfRef.sinegen__DOT__rom2ports__DOT__rom_array
        [vlSelfRef.sinegen__DOT__count];
    vlSelfRef.dout2 = vlSelfRef.sinegen__DOT__rom2ports__DOT__rom_array
        [(0xffU & ((IData)(vlSelfRef.phase) + (IData)(vlSelfRef.sinegen__DOT__count)))];
}
